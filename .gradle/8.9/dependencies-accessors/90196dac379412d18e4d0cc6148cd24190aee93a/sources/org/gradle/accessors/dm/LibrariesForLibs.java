...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final DesktopLibraryAccessors laccForDesktopLibraryAccessors = new DesktopLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>desktop</b>
     */
    public DesktopLibraryAccessors getDesktop() {
        return laccForDesktopLibraryAccessors;
    }
    ...
    public static class CoroutinesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>coroutinesExtensions</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class DesktopLibraryAccessors extends SubDependencyFactory {

        public DesktopLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
    ...
    public static class SqliteLibraryAccessors extends SubDependencyFactory {
        private final SqliteDriverLibraryAccessors laccForSqliteDriverLibraryAccessors = new SqliteDriverLibraryAccessors(owner);

        public SqliteLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>sqlite.driver</b>
         */
        public SqliteDriverLibraryAccessors getDriver() {
            return laccForSqliteDriverLibraryAccessors;
        }

    }

    public static class SqliteDriverLibraryAccessors extends SubDependencyFactory {

        public SqliteDriverLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v201</b> with <b>app.cash.sqldelight:sqlite-driver</b> coordinates and
         * with version reference <b>sqliteDriver</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV201() {
            return create("sqlite.driver.v201");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coroutinesExtensions</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCoroutinesExtensions() { return getVersion("coroutinesExtensions"); }
        ...
        /**
         * Version alias <b>koinCompose</b> with value <b>1.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
